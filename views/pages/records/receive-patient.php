            ...
            <form action="<?= site_url("users/create-user"); ?>" method="post" id="add-user">
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <?= select($this->app->user_titles(), 'title', null, ' ', 'form-control select2', 'id="title" tabindex="1" data-placeholder="Select Title" data-minimum-results-for-search="Infinity" data-clear'); ?>
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <?= select($this->app->user_roles(), 'role', null, ' ', 'form-control select2', 'id="role" tabindex="1" data-placeholder="Select Role" data-minimum-results-for-search="Infinity" data-clear'); ?>
                    </div>
                    <div class="form-group col-md-6">
